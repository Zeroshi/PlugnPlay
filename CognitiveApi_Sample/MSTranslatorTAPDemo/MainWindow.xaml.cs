...
namespace MSTranslatorTAPDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string TEXT_TRANSLATION_API_SUBSCRIPTION_KEY = "Enter Your Subscription Key";
        ...
        private void DetectButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string uri = string.Format("http://api.microsofttranslator.com/v2/Http.svc/Detect?text=" + System.Web.HttpUtility.UrlEncode(txtToTranslate));// + "&to={0}", languageCode);
            ...
            DetectLabel.Content = languageDetected.ToString();
        }
    }
}
